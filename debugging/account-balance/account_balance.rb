...
# What did we do wrong?
  ...
  # The program is just keeping track of one month at a time in the
  # balance variable. Change it to balance += calculate_balance(month)
  # To add up all three months.